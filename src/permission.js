...
const whiteList = ['/login', '/','/home','/course/all','/course/detail','/course/explore/gresmallclass','/course/explore/gre1v1','/course/explore/gmat1v1','/course/explore/gmatsmallclass','/register','/active'] // 不重定向白名单
