...
export default {
  ...
  saveRoom: (class_id, subject, room_id, host_id, begin_timestamp, room_type, password, status) => api.post(`/classroom/saveRoom`, {class_id, subject, room_id, host_id, begin_timestamp, room_type, password, status}),
