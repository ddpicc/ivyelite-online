      ...
      >
        ...
        <div class="card">
          ...
          <div class="card-action word22">
            <button class="action-button signup">
              立即报名
            </button>
            <button class="action-button ask">
              咨询详情
            </button>
          </div>
        </div>
      ...
      <div class="cont">
        <div class="wrap">
          ...
          <v-window v-model="tabIndex">
            ...
            <v-window-item>
              <div class="step-label complete-border" v-bind:class="{'inactive-label': active != 1}">
                <div class="label-title" @click="active=1">咨询老师</div>
              ...
              <div class="step-label" v-bind:class="{'complete-border': step >= 2, 'uncomplete-border': step < 2, 'inactive-label': active != 2}">
                <div class="label-title" @click="active=2">选择课时</div>
              ...
              <div v-if="active == 2" class="step-content" v-bind:class="{'complete-border': step > 2, 'uncomplete-border': step <= 2}">
                <div class="inner-wrap step2">
                  <div class="class-value">
                    <div class="time-option" v-bind:class="{'active': option1_active}" @click="optionSelect(1)">15小时</div>
                    <div class="time-option" v-bind:class="{'active': option2_active}" @click="optionSelect(2)">25小时</div>
                    <div class="time-option" v-bind:class="{'active': option3_active}" @click="optionSelect(3)">35小时</div>
                    <input value="自定义" class="time-option">
                  </div>
                  <div>
                    <button class="step-button next">
                      下一步
              ...
              <div class="step-label" v-bind:class="{'complete-border': step >= 3, 'uncomplete-border': step < 3, 'inactive-label': active != 3}">
                <div class="label-title" @click="active=3">分配课时</div>
              ...
              <div v-if="active == 3" class="step-content" v-bind:class="{'complete-border': step > 3, 'uncomplete-border': step <= 3}">
                <div class="inner-wrap step3">
                  <div class="assign-value">
                    ...
                    <div class="right">
                      <div class="line1">总共课时：35 小时</div>
                      <div class="line2">未选课时：27 小时</div>
                    </div>
                  </div>
                  <div>
                    <button class="step-button next">
              ...
              <div class="step-label" v-bind:class="{'complete-border': step >= 4, 'uncomplete-border': step < 4, 'inactive-label': active != 4}">
                <div class="label-title" @click="active=4">个人信息</div>
              ...
              <div class="step-label" v-bind:class="{'complete-border': step >= 5, 'uncomplete-border': step < 5, 'inactive-label': active != 5}">
                <div class="label-title" @click="active=5">在线支付</div>
                  ...
                  <div class="card">
                    <div class="part1">
                      ...
                      <div class="d-flex line2">
                        <div>姓名：小明</div>
                        <div>微信号：dftrrgr</div>
                        <div>邮箱：dftrrgr@gmail.com</div>
                      </div>
                    </div>
                    <div class="part2">
                      <div class="title2">课时分配</div>
                      <div class="subtitle2 line2">总共课时：54小时</div>
              ...
              <div class="step-label" v-bind:class="{'complete-border': step >= 6, 'uncomplete-border': step < 6, 'inactive-label': active != 6}">
                <div class="label-title" @click="active=6">报名成功</div>
              </div>
