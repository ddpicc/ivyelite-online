      ...
      >
        <div class="cont">
          <div class="title-wrap">
            <div class="title-size">GMAT 1v1 私教班</div>
            <div class="yellow-line"></div>
          </div>
          <div class="banner-bullet">
            常青藤精英教育的一对一GMAT私教课，为每位学员<br>定制化教学方案及管家式习题讲解, 自定义课程时间。<br>开课前精准评估各知识点掌握程度，优先强化训练高<br>频薄弱知识点。
          </div>
        ...
        <div class="wrap">
          ...
          <v-window v-model="tabIndex">
            ...
            <v-window-item>
              ...
              <!-- 报名成功 -->
              <div id="href-success" class="step-label" v-bind:class="{'complete-border': step >= 6, 'uncomplete-border': step < 6, 'inactive-label': active != 6}">
