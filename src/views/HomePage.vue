  ...
  <body>
    ...
    <header> 
      ...
      <div class="container header-middle">
        <div class="row"> 
          <span class="col-xs-6 col-sm-3"><a href="index.html"><img src="../assets/logo.png" class="img-responsive" alt=""></a></span>
        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse" id="navbar">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><router-link to="/course/all">Courses</router-link></li>
          ...
          <div class="container">
            <div class="content animated fadeInRight">
              <div class="fl-right">
                ...
                <a href="about.html" class="btn animated fadeInRight">Know More <span class="icon-more-icon"></span></a> </div>
            </div>
          </div>
        </v-carousel-item>
        <v-carousel-item class="slide2">
          <div class="container">
            <div class="content">
    ...
    <section class="about">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-7 col-sm-push-5 left-block"> <span class="sm-head">the Unique Education</span>
            <h2>最强大脑 – 如何高效记忆GRE核心词</h2>
            <p>最强大脑中国队队长，世界记忆大师李威老师曾受邀到哈佛大学、哥伦比亚大学等顶尖名校分享高效记忆方法和思维，并收获大批学生的青睐和赞赏。常青藤精英教育Ivy Elite 特邀李威老师为GRE暑假班全体学员亲授GRE核心词汇记忆大法，助力大家短时间克服单词难关，冲击高分并申请名校！
            </p>
          ...
          <div class="col-sm-5 col-sm-pull-7">
            <div class="video-block">
              ...
              <a href="#" data-toggle="modal" data-target="#myModal" class="start-video"><img src="../assets/images/play-btn.png" alt=""></a> 
              <!-- Modal -->
            ...
            <div class="grid_item wd55">
              <div class="courses_item">
                ...
                <div class="hover_text">
                  <router-link class="cat" to="/course/detail">详情</router-link>
                  <a href="#"><h4>GRE 全场提分班</h4></a>
                  <ul class="list">
      ...
      <div class="container">
        ...
        <ul class="our-strength">
          ...
          <li>
            ...
            <div class="couter-outer"><ICountUp
              :delay="1000"
              :endVal="86"
              :options="options"
            /><span>%</span></div>
      ...
      <div class="container">
        ...
        <ul class="row browse-teachers-list clearfix">
          <li class="col-xs-6 col-sm-3">
            <figure> <img src="../assets/images/teacher1.jpg" width="123" height="124" alt=""> </figure>
...
export default {
  ...
  methods: {
    ...
    handleScroll(){      
      let docSrollTop = document.documentElement.scrollTop   //文档卷动值  1862 开始进入
      let clientH = document.documentElement.clientHeight  //视窗大小   976
      let sectionTop = window.pageYOffset + document.querySelector(".our-strength").getBoundingClientRect().top //动态文字模块距离文档头部的距离  3050
      let sectionH = parseInt(window.getComputedStyle(document.querySelector(".our-strength")).getPropertyValue('height')) //133
...
.banner-outer .slide1 {
	background: url(../assets/images/banner1.jpg) no-repeat center top / cover;
}
.banner-outer .slide2 {
	background: url(../assets/images/banner2.jpg) no-repeat center top / cover;
}
.banner-outer .slide3 {
	background: url(../assets/images/banner3.jpg) no-repeat center top / cover;
}
...
.about {
	...
	background: url(../assets/images/about-bg.jpg) no-repeat center bottom;
}
.about ul.our-links {
	display: block;
	margin: -280px 0 0 0;
...
.our-cources:after {
	...
	z-index: 1;
	content: "";
	background: url(../assets/images/cources-bg.jpg) no-repeat center top / cover;
	opacity: 0.2;
}
...
.our-cources ul.course-list li {
	display: block;
	background: url(../assets/images/book-bg.png) no-repeat center top;
	position: relative;
}
...
.why-choose:after {
	...
	z-index: 1;
	content: "";
	background: url(../assets/images/why-choose-bg.jpg) no-repeat center center / cover;
	opacity: 0.1;
}
.why-choose h2 {
	padding-bottom: 70px;
...
.mfp-arrow-left:before, .mfp-arrow-right:after {
	...
	display: block;
	content: "";
	background: url(../assets/images/popup-arrows.png) no-repeat center bottom;
}
...
.mfp-image-holder .mfp-close, .mfp-iframe-holder .mfp-close {
	...
	display: block;
	cursor: pointer;
	background: url(../assets/images/popup-close.png) no-repeat center top;
	text-indent: 100%;
	white-space: nowrap;
	overflow: hidden;
}
...
.testimonial:after {
	...
	z-index: 1;
	content: "";
	background: url(../assets/images/testimonial-bg.jpg) no-repeat center top / cover;
	opacity: 0.15;
}
...
.about-video:after {
	...
	z-index: 1;
	content: "";
	background: url(../assets/images/about-video-bg.jpg) no-repeat center top / cover;
	opacity: 0.4;
}
...
.about .close span, .about-video .close span {
	...
	display: block;
	text-indent: -9999px;
	background: url(../assets/images/popup-close-btn.jpg) no-repeat center top;
}
.modal {
	z-index: 99999;
}
...
.inner-banner {
	...
	padding: 60px 0;
	min-height: 290px;
	background: url(../assets/images/inner-banner-bg.jpg) no-repeat center top / cover;
}
...
.our-cources.sub:after {
	background: url(../assets/images/cources-bg1.jpg) no-repeat center top / cover;
}
.our-cources.sub h2 {
	padding-left: 32px;
	text-align: left;
...
ul.browse-teachers-list figure:before {
	...
	right: 0px;
	top: 0px;
	background: url(../assets/images/teacher-overlay-bg.png) no-repeat center top;
}
.browse-teacher.grey-bg ul.browse-teachers-list figure:before {
	background: url(../assets/images/teacher-overlay-bg-grey.png) no-repeat center top;
}
.details-tab ul.browse-teachers-list figure:before {
	background: url(../assets/images/teacher-overlay-bg-tab.png) no-repeat center top;
}
...
.how-apply ul li:nth-child(1):after {
	...
	right: -120px;
	top: 86px;
	background: url(../assets/images/dotted-arrow.png) no-repeat left top;
	z-index: -1;
}
.how-apply ul li:nth-child(2):after {
	...
	right: -122px;
	top: 32px;
	background: url(../assets/images/dotted-arrow1.png) no-repeat left top;
	z-index: -1;
}
...
.not-found-wrapper {
	...
	margin: 130px auto;
	padding: 240px 0 0 0;
	background: url(../assets/images/404-img.png) no-repeat center top / 100%;
	text-align: center;
}
...
ul.testimonials li:after, ul.testimonials li:nth-child(2n):before, ul.testimonials li:nth-child(3n):before {
	...
	display: block;
	content: "";
	background: url(../assets/images/testi-clip.png) no-repeat left top;
	position: absolute;
	bottom: -4px;
}
